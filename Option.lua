      ...
      Group = {
        ...
        args = {
          ...
          tauntCommon = {
            type = "input",
            disabled = function()
              return not (self.Settings.profile.gSetting.CCCommonIcon and self.Settings.profile.Group.taunt)
            end,
            order = 11,
            name = L["taunt name"],
          ...
          incapacitateCommon = {
            type = "input",
            disabled = function()
              return not (self.Settings.profile.gSetting.CCCommonIcon and self.Settings.profile.Group.incapacitate)
            end,
            order = 12,
          ...
          silenceCommon = {
            type = "input",
            disabled = function()
              return not (self.Settings.profile.gSetting.CCCommonIcon and self.Settings.profile.Group.silence)
            end,
            order = 13,
            name = L["silence name"],
          ...
          disorientCommon = {
            type = "input",
            disabled = function()
              return not (self.Settings.profile.gSetting.CCCommonIcon and self.Settings.profile.Group.disorient)
            end,
            order = 14,
          ...
          stunCommon = {
            type = "input",
            disabled = function()
              return not (self.Settings.profile.gSetting.CCCommonIcon and self.Settings.profile.Group.stun)
            end,
            order = 15,
            name = L["stun name"],
          ...
          rootCommon = {
            type = "input",
            disabled = function()
              return not (self.Settings.profile.gSetting.CCCommonIcon and self.Settings.profile.Group.root)
            end,
            order = 16,
            name = L["root name"],
          ...
          knockbackCommon = {
            type = "input",
            disabled = function()
              return not (self.Settings.profile.gSetting.CCCommonIcon and self.Settings.profile.Group.knockback)
            end,
            order = 17,
          ...
          disarmCommon = {
            type = "input",
            disabled = function()
              return not (self.Settings.profile.gSetting.CCCommonIcon and self.Settings.profile.Group.disarm)
            end,
            order = 18,
            name = L["disarm name"],
